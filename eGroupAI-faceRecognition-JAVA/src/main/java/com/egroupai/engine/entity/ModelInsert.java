...
public class ModelInsert {
	...
	private String modelInsertStatusPath;
	// init func
	...
	public String getModelInsertStatusPath() {
		return modelInsertStatusPath;
	}
	public void setModelInsertStatusPath(String modelInsertStatusPath) {
		this.modelInsertStatusPath = modelInsertStatusPath;
	} 
}
